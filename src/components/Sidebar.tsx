  ...
  return (
    <>
      ...
      <aside
        ...
        style={{ width: 256, background: "var(--ink)", color: "#fff", flexShrink: 0, display: "flex", flexDirection: "column", padding: "22px 16px", position: "sticky", top: 0, height: "100vh" }}
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "0 6px 22px" }}>
          ...
          <button
            ...
            style={{ border: "none", background: "none", color: "#8891A0", fontSize: 20, cursor: "pointer", padding: 4 }}
          >
            ✕
          </button>
        </div>
